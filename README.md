...
If you are running Control Tower v2.8 or later, this application also provides a 
...
left to the individual developer. The obvious brute-force approach of concatenating kog files together 
