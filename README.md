...
again per file, incurred when moving to permanent deep storage in Glacier. 
...
have been added to the dummy file, a final result file is produced by making another copy without 
the initial 5 MB of dummy data.
